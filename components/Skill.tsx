...
function Skill({ directionLeft, skill }: Props) {
  return (
    <div className='group relative top-8 sm:top-24 flex cursor-pointer'>
        ...
        />
        <div className='absolute opacity-0 group-hover:opacity-80 transition duration-300 ease-in-out group-hover:bg-[#F7AB0A]/40 w-10 h-10 sm:w-14 sm:h-14 md:w-16 md:h-16 xl:w-20 xl:h-20 rounded-full z-0'>
